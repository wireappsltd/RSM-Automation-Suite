...
import com.rsm.PO.RSMMyRawMaterialsPage;

public class TC_MyRawMaterials extends BaseClass {
...
private static String url = "https://portal-surovin-dev.azurewebsites.net/Welcome";
	...
	public void addNewRawMaterial() throws InterruptedException, IOException {
		
		RSMMyRawMaterialsPage rmp = new RSMMyRawMaterialsPage(driver);
		
		rmp.clickOnMyRawMaterials();
		
		rmp.clickOnAddNewRawMaterial();
